...
audio_cfg = {
    ...
    "codec": "melspec",  # {melspec, spec, m2l} melspec for MT3, spec for PerceiverTF
...
"""
model_cfg = {
    "encoder_type": "t5",  # {"t5", "perceiver-tf", "conformer", None}
    "decoder_type": "t5", # {"t5", "multi-t5"}
    "pre_encoder_type": "default",  # {None, "default", "conv", "conv1d", "conv2d_avpt", "m2l_adapter"} by default, t5:None, perceiver:conv.
...
shared_cfg = {
    ...
    "CHECKPOINT": {
        ...
        "filename": "{epoch}-{step}",
        "save_weights_only": True, # Set False to save the optimizer and scheduler states
    },
