...
task_cfg = {
    ...
    "mt3_full_plus_vel": { # 34 classes (except drums) as in MT3 paper + singing + drum class w/ velocity (0-127)
        "name": "mt3_full_plus_vel",
        "train_program_vocab": program_vocab_presets["mt3_full_plus"],
        "train_drum_vocab": drum_vocab_presets["gm"],
        "base_codec": "mt3_vel", # to allow velocity (0-127)
    },
