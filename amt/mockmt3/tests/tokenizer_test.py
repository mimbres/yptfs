...
from mockmt3.utils.note_event_dataclasses import NoteEvent, Event, EventRange
from mockmt3.utils.event_codec import FastCodec as Codec
from mockmt3.utils.tokenizer import EventTokenizer
from mockmt3.utils.tokenizer import NoteEventTokenizer
...
class TestEventTokenizerBase(unittest.TestCase):
    ...
    def test_encode_and_decode(self):
        ...
        events = [Event('pitch', 64), Event('velocity', 1), Event('tie', 0), Event('program', 10), Event('drum', 0)]
    ...
    def test_encode_and_decode_with_custom_codec(self):
        ...
        events = [Event('eat', 3), Event('shift', 9), Event('sleep', 9), Event('shift', 20), Event('play', 1)]
        tokens = tokenizer.encode(events)
