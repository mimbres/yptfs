...
class TestNoteMidiConversion(unittest.TestCase):
    ...
    def test_note2midi2note_z(self):
        original_notes = [
            Note(is_drum=False, program=3, onset=0., offset=1., pitch=60, velocity=100),
            Note(is_drum=False, program=3, onset=1., offset=2., pitch=64, velocity=100),
        ]
        ...
        with NamedTemporaryFile(suffix=".mid", delete=True) as temp_file:
            ...
            note_event2midi(note_events, temp_file.name, binary_velocity=False)
    ...
    def test_midi2note2midi2note_piano_z(self):
        ...
        note_event2midi(note_events, 'extras/examples/piano_converted.mid', binary_velocity=True)
    ...
    def test_midi2note2midi2note_force_drum_z(self):
        ...
        note_events = note2note_event(notes=notes, sort=True)
        note_event2midi(note_events, conv_file, binary_velocity=True, ticks_per_beat=960)
