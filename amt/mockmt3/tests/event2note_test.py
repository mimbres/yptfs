...
from mockmt3.utils.note_event_dataclasses import Event, Note, NoteEvent
from mockmt3.utils.event2note import event2note_event
from mockmt3.utils.event2note import note_event2note
...
class TestNoteEvent2Note(unittest.TestCase):
    ...
    def test_note_event2note(self):
        ...
        note_events = [NoteEvent(is_drum=False, program=33, time=0, velocity=100, pitch=60),
    ...
    def test_note_event2note_simple_cases(self):
        ...
        note_events = [
            NoteEvent(is_drum=False, program=0, time=0.1, velocity=100, pitch=60),
            NoteEvent(is_drum=False, program=0, time=0.5, velocity=0, pitch=60),
            NoteEvent(is_drum=False, program=0, time=0.7, velocity=100, pitch=62),
            NoteEvent(is_drum=False, program=0, time=1.5, velocity=0, pitch=62),
        ]

        expected_notes = [
            Note(is_drum=False, program=0, onset=0.1, offset=0.5, pitch=60, velocity=100),
            Note(is_drum=False, program=0, onset=0.7, offset=1.5, pitch=62, velocity=100),
        ]
        ...
        note_events = [
            NoteEvent(is_drum=True, program=128, time=0.2, velocity=100, pitch=36),
            NoteEvent(is_drum=True, program=128, time=0.3, velocity=100, pitch=38),
        ...
        expected_notes = [
            Note(is_drum=True, program=128, onset=0.2, offset=0.21, pitch=36, velocity=100),
            Note(is_drum=True, program=128, onset=0.3, offset=0.31, pitch=38, velocity=100),
        ]
        notes, err_cnt = note_event2note(note_events)
        self.assertEqual(len(err_cnt), 0)
    ...
    def test_note_event2note_multiple_overlapping_notes(self):
        ...
        note_events = [
            NoteEvent(is_drum=False, program=1, time=0.0, velocity=100, pitch=60),
            NoteEvent(is_drum=False, program=1, time=0.5, velocity=0, pitch=60),
            NoteEvent(is_drum=False, program=1, time=1.0, velocity=100, pitch=62),
            NoteEvent(is_drum=False, program=1, time=1.5, velocity=0, pitch=62),
            NoteEvent(is_drum=False, program=2, time=0.25, velocity=100, pitch=60),
            NoteEvent(is_drum=False, program=2, time=0.75, velocity=0, pitch=60),
            NoteEvent(is_drum=False, program=2, time=1.25, velocity=100, pitch=62),
            NoteEvent(is_drum=False, program=2, time=1.75, velocity=0, pitch=62),
            NoteEvent(is_drum=False, program=3, time=0.0, velocity=100, pitch=64),
            NoteEvent(is_drum=False, program=3, time=1.0, velocity=0, pitch=64),
            NoteEvent(is_drum=False, program=4, time=0.5, velocity=100, pitch=66),
            NoteEvent(is_drum=False, program=4, time=1.5, velocity=0, pitch=66),
            NoteEvent(is_drum=False, program=4, time=0.75, velocity=100, pitch=67),
            NoteEvent(is_drum=False, program=4, time=1.75, velocity=0, pitch=67),
            NoteEvent(is_drum=False, program=4, time=1.0, velocity=100, pitch=69),
        ...
        expected_notes = [
            ...
            Note(is_drum=False, program=3, onset=0.0, offset=1.0, pitch=64, velocity=100),
            Note(is_drum=False, program=2, onset=0.25, offset=0.75, pitch=60, velocity=100),
            Note(is_drum=False, program=4, onset=0.5, offset=1.5, pitch=66, velocity=100),
            Note(is_drum=False, program=4, onset=0.75, offset=1.75, pitch=67, velocity=100),
            Note(is_drum=False, program=1, onset=1.0, offset=1.5, pitch=62, velocity=100),
            Note(is_drum=False, program=4, onset=1.0, offset=2.0, pitch=69, velocity=100),
            Note(is_drum=False, program=2, onset=1.25, offset=1.75, pitch=62, velocity=100)
        ]
