...
from mockmt3.utils.utils import download_and_extract
from mockmt3.utils.utils import get_checksum
from mockmt3.utils.utils import merge_file_lists
from mockmt3.utils.utils import reindex_file_list_keys
from mockmt3.utils.utils import remove_ids_from_file_list
from mockmt3.utils.utils import deduplicate_splits
...
class TestMergeFileListFunctions(unittest.TestCase):
    ...
    def test_remove_ids_from_file_list(self):
        file_list = {'a': {'music_id': 123, 'name': 'file1'}, 'b': {'music_id': 222, 'name': 'file2'}}
        selected_ids = [123]
