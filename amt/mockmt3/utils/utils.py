...
from mockmt3.config.vocabulary import GM_INSTR_FULL, GM_INSTR_CLASS_PLUS
...
def write_model_output_as_midi(notes: List[Note],
                               ...
                               input_binary_velocity: bool = False) -> None:
    """
    input_binary_velocity: If True, all velocity for onset are set to 100 (useful for mt3's binary velociy outputs).
    """
    ...
    note_event2midi(note_events,
                    output_file,
                    output_inverse_vocab=output_inverse_vocab,
                    binary_velocity=input_binary_velocity)
