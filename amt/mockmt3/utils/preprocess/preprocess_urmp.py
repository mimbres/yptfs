...
from mockmt3.utils.note2event import note2note_event, mix_notes, sort_notes, validate_notes, trim_overlapping_notes
from mockmt3.utils.event2note import event2note_event
from mockmt3.utils.note_event_dataclasses import Note, NoteEvent
from mockmt3.utils.utils import note_event2token2note_event_sanity_check, freq_to_midi
    ...
    for ann_file, prog in zip(ann_files, program):
        ...
        for o, f, d in zip(onset, freq, duration):
            notes_by_instr.append(
                Note(is_drum=False, program=prog, onset=o, offset=o + d, pitch=freq_to_midi(f), velocity=100))
