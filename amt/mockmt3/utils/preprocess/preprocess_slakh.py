...
from mockmt3.utils.note2event import note2note_event, mix_notes
import mirdata
from mockmt3.utils.mirdata_dev.datasets import slakh16k


def create_audio_stem_from_mtrack(ds: mirdata.core.Dataset, mtrack_id: str, delete_source_files: bool = False) -> Dict:
...
def create_note_event_and_note_from_mtrack_mirdata(ds: mirdata.core.Dataset,
                                                   mtrack_id: str,
...
def preprocess_slakh16k(data_home: str,
    ...
    for split in ['train', 'validation', 'test']:
        ...
        for i, mtrack_id in enumerate(mtrack_ids):
            ...
            notes, note_events = create_note_event_and_note_from_mtrack_mirdata(ds,
                                                                                mtrack_id,
                                                                                fix_bass_octave=fix_bass_octave)
        ...
        print(f"⏰: {int(elapsed_time // 3600):02d}h {int(elapsed_time % 3600 // 60):02d}m {elapsed_time % 60:.2f}s")
