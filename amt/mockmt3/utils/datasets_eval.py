...
from mockmt3.utils.audio import load_audio_file, slice_padded_array
from mockmt3.utils.tokenizer import EventTokenizerBase, NoteEventTokenizer
...
class AudioFileDataset(Dataset):
    ...
    def __getitem__(self, index: int) -> Tuple[np.ndarray, Dict, NoteEventListsBundle]:
        ...
        # load all notes from a file (of a single song)
