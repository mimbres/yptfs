...
from mockmt3.utils.datasets_train import get_cache_data_loader
from mockmt3.utils.datasets_eval import get_eval_dataloader
from mockmt3.utils.datasets_helper import create_merged_train_dataset_info, get_list_of_weighted_random_samplers
...
class AMTDataModule(LightningDataModule):
    ...
    def train_dataloader(self) -> Any:
        ...
        for i, args_dict in enumerate(self.train_data_args):
            loaders[f"data_loader_{i}"] = get_cache_data_loader(**args_dict,
                                                                dataloader_config=self.shared_cfg["DATAIO"])
