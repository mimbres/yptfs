...
from mockmt3.utils.note_event_dataclasses import Event, EventRange, Note  #, Codec
from mockmt3.utils.event_codec import FastCodec as Codec
from mockmt3.utils.note_event_dataclasses import NoteEvent
...
from typing import List, Optional, Union, Tuple, Dict, Counter, Literal
...
class EventTokenizerBase(ABC):
    ...
    def __init__(
        self,
        base_codec: Union[Codec, Literal['mt3', 'mt3_vel']] = 'mt3',
        ...
        :param base_codec: The codec to use for encoding and decoding. "mt3" or "mt3_vel"
        ...
        if isinstance(base_codec, str):
            ...
            if base_codec.lower() == 'mt3':
                ...
                codec_name = 'mt3'
            elif base_codec.lower() == 'mt3_vel':  # extending velocity (0-127), where 0 is offset
                event_ranges = [
                    EventRange('pitch', min_value=0, max_value=127),
                    EventRange('velocity', min_value=0, max_value=127),
                    EventRange('tie', min_value=0, max_value=0),
                    EventRange('program', min_value=0, max_value=127),
                    EventRange('drum', min_value=0, max_value=127),
                ]
...
class EventTokenizer(EventTokenizerBase):
    ...
    def __init__(self,
        ...
        :param codec: The codec to use for encoding and decoding. 'mt3' or 'mt3_vel'
        :param special_tokens: None or list of special tokens to include in the vocabulary.
        :param extra_tokens: None or list of tokens to be treated as additional special tokens.
        :param program_vocabulary: None or a dictionary mapping program names to program indices.
        :param drum_vocabulary: None or a dictionary mapping drum names to drum indices.
