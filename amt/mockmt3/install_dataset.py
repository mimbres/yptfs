...
from mockmt3.utils.preprocess.generate_dataset_stats import generate_dataset_stats_for_all_datasets, update_dataset_stats_for_new_dataset
from mockmt3.utils.mirdata_dev.datasets import slakh16k
from mockmt3.utils.preprocess.preprocess_slakh import preprocess_slakh16k, add_program_and_is_drum_info_to_file_list
from mockmt3.utils.preprocess.preprocess_musicnet import preprocess_musicnet16k
from mockmt3.utils.preprocess.preprocess_maps import preprocess_maps16k
from mockmt3.utils.preprocess.preprocess_maestro import preprocess_maestro16k
from mockmt3.utils.preprocess.preprocess_guitarset import preprocess_guitarset16k, create_filelist_by_style_guitarset16k
from mockmt3.utils.preprocess.preprocess_enstdrums import preprocess_enstdrums16k, create_filelist_dtm_random_enstdrums16k
from mockmt3.utils.preprocess.preprocess_mir_st500 import preprocess_mir_st500_16k
from mockmt3.utils.preprocess.preprocess_cmedia import preprocess_cmedia_16k
from mockmt3.utils.preprocess.preprocess_rwc_pop_full import preprocess_rwc_pop_full16k
from mockmt3.utils.preprocess.preprocess_rwc_pop import preprocess_rwc_pop16k
from mockmt3.utils.preprocess.preprocess_egmd import preprocess_egmd16k
from mockmt3.utils.preprocess.preprocess_mir1k import preprocess_mir1k_16k
from mockmt3.utils.preprocess.preprocess_urmp import preprocess_urmp16k
from mockmt3.utils.preprocess.preprocess_idmt_smt_bass import preprocess_idmt_smt_bass_16k
from mockmt3.utils.preprocess.preprocess_geerdes import preprocess_geerdes16k
from mockmt3.utils.utils import download_and_extract  #, download_and_extract_zenodo_restricted
...
def option_prompt(data_home: os.PathLike, no_download: bool = False) -> None:
    ...
    print("11. MIR-1K (Not implemented yet)")
    print("12. URMP")
    print("13. IDMT-SMT-Bass")
    print("14. Random-NSynth (Not implemented yet)")
    print("15. Geerdes (Not Open Dataset)")
...
if __name__ == "__main__":
    ...
    if args.data_home is None:
        from mockmt3.config.config import shared_cfg
