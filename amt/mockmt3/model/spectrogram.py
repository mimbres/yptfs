...
from mockmt3.model.ops import minmax_normalize
from mockmt3.config.config import audio_cfg as default_audio_cfg

# from mockmt3.model.m2l_layer import M2LLayer
"""
Example usage:
...
def get_spectrogram_layer_from_audio_cfg(audio_cfg: Optional[Dict] = None) -> Tuple[nn.Module, Tuple[int]]:
    """Get mel-/spectrogram layer from mockmt3.config.
    ...
    elif audio_cfg['codec'].lower() == 'm2l-fe':
        from mockmt3.model.m2l_layer import M2LLayer
        layer = M2LLayer(pretrained=True, extract_features=True, apply_1x1conv_to_output=False)
    elif audio_cfg['codec'].lower() == 'm2l-fe-1x1':
        from mockmt3.model.m2l_layer import M2LLayer
        layer = M2LLayer(pretrained=True, extract_features=True, apply_1x1conv_to_output=True)
    else:
